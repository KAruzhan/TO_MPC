...
public:
    RobotCommandPublisher() : Node("robot_command_publisher"), count_(0)
    {
        ...
        MyFile.open("solver_to_stats.csv"); //, std::ofstream::out | std::ofstream::app);
...
private:
    ...
    void timer_callback()
    {
            ...
            std::cout << "Result:" << results[6] << std::endl;
    ...
    {   
        ...
        constexpr double OFFSET = 0.0;    // Offset for trajectory timing
