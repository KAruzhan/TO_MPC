...
human_spheres = [0.0517,   0.5220,   1.0895,
    ...
    def timer_callback(self):       
        ...
        try:
            ...
            if self.sphere_pose_counter%20:
                ...
                random_position_1 = [human_spheres[0+3*0],human_spheres[1+3*0],human_spheres[2+3*0]]
                random_position_2 = [human_spheres[0+3*1],human_spheres[1+3*1],human_spheres[2+3*1]]
                random_position_3 = [human_spheres[0+3*2],human_spheres[1+3*2],human_spheres[2+3*2]]
                random_position_4 = [human_spheres[0+3*3],human_spheres[1+3*3],human_spheres[2+3*3]]
                random_position_5 = [human_spheres[0+3*4],human_spheres[1+3*4],human_spheres[2+3*4]]
                random_position_6 = [human_spheres[0+3*5],human_spheres[1+3*5],human_spheres[2+3*5]]
                random_position_7 = [human_spheres[0+3*6],human_spheres[1+3*6],human_spheres[2+3*6]]
                random_position_8 = [human_spheres[0+3*7],human_spheres[1+3*7],human_spheres[2+3*7]]
                random_position_9 = [human_spheres[0+3*8],human_spheres[1+3*8],human_spheres[2+3*8]]
                random_position_10 = [human_spheres[0+3*9],human_spheres[1+3*9],human_spheres[2+3*9]]
                random_position_11 = [human_spheres[0+3*10],human_spheres[1+3*10],human_spheres[2+3*10]]
                random_position_12 = [human_spheres[0+3*11],human_spheres[1+3*11],human_spheres[2+3*11]]
                random_position_13 = [human_spheres[0+3*12],human_spheres[1+3*12],human_spheres[2+3*12]]
                random_position_14 = [human_spheres[0+3*13],human_spheres[1+3*13],human_spheres[2+3*13]]
                start = time.time()
